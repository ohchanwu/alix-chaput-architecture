...
**YOU ARE IN: `alix_chaput_architecture/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/alix_chaput_architecture/` (rig root) or other directories
...
**Your mail address:** `alix_chaput_architecture/polecats/furiosa`
**Your rig:** alix_chaput_architecture
**Your Witness:** `alix_chaput_architecture/witness`
...
| Ask Witness for help | `gt mail send alix_chaput_architecture/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`alix_chaput_architecture/witness`) when:
...
```bash
gt mail send alix_chaput_architecture/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
